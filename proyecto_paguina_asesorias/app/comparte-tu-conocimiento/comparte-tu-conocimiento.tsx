...
import { RiArrowUpLine, RiCloudLine, RiFile2Fill, RiFile2Line, RiSlideshowLine } from "@remixicon/react";
                ...
                <div className="flex flex-col lg:col-span-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                        {shareYourKnowledgeOptions.map((option, index) => (
                            <Card key={index} className="items-center bg-yellow-200/10 dark:bg-yellow-500/5 ring-0 border border-transparent dark:border-yellow-600/30">
                                <CardContent className="bg-yellow-600 flex items-center justify-center rounded-full p-4">
                                    {option.icon}
                                </CardContent>

                                <CardHeader className="flex items-center justify-center">
                                    <CardTitle className=""><H4 className="font-bold text-blue-900 dark:text-amber-400">{option.title}</H4></CardTitle>
                                </CardHeader>
                ...
                <div className="flex border-yellow-600 border-2 p-6 bg-blue-700/5 dark:bg-blue-950/20 rounded-xl border-dashed lg:col-span-1 min-w-0">
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        ...
                        <div className="flex flex-col items-center justify-center gap-2 border-zinc-300 dark:border-zinc-800 border-2 p-6 rounded-xl border-dashed">
                            ...
                            <H4 className="text-blue-900 dark:text-blue-200 font-bold text-center">Arrastra y suelta tu recurso aquí</H4>

                            <Muted className="text-foreground/70 text-center">o haz click para seleccionar</Muted>
                        </div>
                        ...
                        <div className="flex gap-4 flex-col">
                            ...
                            <FieldSet >
                                <FieldGroup>
                                    ...
                                    <Field className="w-full">
                                        <FieldLabel className="font-bold text-blue-900 dark:text-zinc-300">Semestre</FieldLabel>
                                        <Select>
                                    ...
                                    {/* course */}
                                    <Field className="w-full">
                                        <FieldLabel className="font-bold text-blue-900 dark:text-zinc-300">Materia</FieldLabel>
                                        <Select>
                                            <SelectTrigger className="bg-background">
                                            ...
                                            <SelectContent>
                                                <SelectGroup>
                                                    ...
                                                    <SelectItem value="5">Solución Algoritmica de Problemas</SelectItem>
                                                    <SelectItem value="6">Organización de Computadoras</SelectItem>
                                                </SelectGroup>
                                            </SelectContent>
                                        </Select>
                                    </Field>
                                    ...
                                    {/* resource type */}
                                    <Field className="w-full">
                                        <FieldLabel className="font-bold text-blue-900 dark:text-zinc-300">Tipo de recurso</FieldLabel>
                                        <Select>
                                            <SelectTrigger className="bg-background">
                            ...
                            <FieldSet>
                                <FieldGroup >
                                    {/* title */}
                                    <Field className="w-full">
                                        <FieldLabel className="font-bold text-blue-900 dark:text-zinc-300">Título</FieldLabel>
                                        <Input placeholder="Ej. Introducción al Cálculo Diferencial e Integral..." className="bg-background" />
                                    </Field>

                                    {/* description */}
                                    <Field className="w-full">
                                        <FieldLabel className="font-bold text-blue-900 dark:text-zinc-300">Descripción</FieldLabel>
                                        <Textarea placeholder="Describe brevemente el contenido de tu material." className="bg-background" />
                                    </Field>
                                </FieldGroup>
                            </FieldSet>
                        </div>
                        ...
                        <div className="flex justify-center">
                            <Button variant={"outline"} className="bg-emerald-200/50 text-emerald-700 hover:bg-emerald-200/70 dark:bg-emerald-950/40 dark:text-emerald-400 dark:hover:bg-emerald-950/60 ring-0 border border-transparent dark:border-emerald-800/30 font-bold"><RiArrowUpLine /> Subir Recurso</Button>
                        </div>
